    ...
    @foreach ($reports_last_week as $report)
      <tr>
        ...
        <td><div class="col-sm-10">
          <input type="text" name="last_week_task_name[]" class="form-control-plaintext mt-0 pt-0" value="{{$report->task_name}}" placeholder="入力してください"></input>
          </div>
        </td>
        <td>
          <div class="col-sm-10">
          <textarea class="form-control" name="last_week_task_detail[]"  placeholder="入力してください">{{$report->task_detail}}</textarea >
          </div>
        </td>
        <td  style="">
        ...
        <div class="row">
          <div class="col">
              <input type="text" name="last_week_m[]" class="form-control-plaintext mt-0 pt-0" value="{{$report->m}}" placeholder="0"></input>
          </div>
          <div class="col">
            <span>M</span>
          </div>
