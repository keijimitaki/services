...
class WebGLFrame {
    ...
    load(){
        ...
        return new Promise((resolve) => {
            this.loadShader([
                './wp-content/themes/tanoshimidev/js/vs1.vert',
                './wp-content/themes/tanoshimidev/js/fs1.frag',
            ])
            .then((shaders) => {
                const gl = this.gl;
                ...
                //return this.createTextureFromFile('./base_green.png');
                //return this.createTextureFromFile('./base_purple.png');
                
                const base_img = [
                    './wp-content/themes/tanoshimidev/image/webgl/background/01_purple.png','./wp-content/themes/tanoshimidev/image/webgl/background/02_smokypink.png','./wp-content/themes/tanoshimidev/image/webgl/background/03_fluid.png','./wp-content/themes/tanoshimidev/image/webgl/background/04_lightning_pink.png',
                    './wp-content/themes/tanoshimidev/image/webgl/background/05_blue.png','./wp-content/themes/tanoshimidev/image/webgl/background/06_green.png','./wp-content/themes/tanoshimidev/image/webgl/background/07_goldsplash.png','./wp-content/themes/tanoshimidev/image/webgl/background/08_square.png','./wp-content/themes/tanoshimidev/image/webgl/background/01_purple.png',
                ];
                let index = Math.floor(Math.random() * 9);
                return this.createTextureFromFile(base_img[index]);
            ...
            .then((texture) => {
                ...
                return this.createTextureFromFile('./wp-content/themes/tanoshimidev/image/webgl/height.png');
            })
            .then((texture) => {
                // ハイトマップテクスチャ
    ...
    setup(){
        ...
        window.addEventListener('mousemove', (evt) => {
            const x = (evt.clientX / this.canvas.width) * 4.0 - 1.0;
            const y = (evt.clientY / this.canvas.height) * 4.0 - 1.0;
            mouse = [x, y];
        }, false);
